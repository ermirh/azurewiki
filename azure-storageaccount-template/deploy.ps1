...
$templateParam = "C:\Users\ehoxhaj\Desktop\Box Sync\azurewiki\azure-storageaccount-template\template.parameters.json"
$template = "C:\Users\ehoxhaj\Desktop\Box Sync\azurewiki\azure-storageaccount-template\template.json"
